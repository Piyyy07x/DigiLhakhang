...
import { Headphones, MapPin, Calendar, Globe, Clock } from "lucide-react"
import Link from "next/link"
import type { Monastery } from "@/lib/types"

interface AudioGuidesGridProps {
...
export function AudioGuidesGrid({ monasteries }: AudioGuidesGridProps) {
  return (
